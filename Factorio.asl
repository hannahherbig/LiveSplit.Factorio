...
state("Factorio", "1.1.61-steam") {
	//Check whether we are in a game and whether or not the game is paused"
	ulong 	gamePointer : 0x1C7DC70, 0x68;
	ulong	researchArea: 0x1C7DC70, 0x68, 0x68, 0x2D0, 0x70, 0x8, 0x0;
	ulong	buildingNumberArea:	0x1C7DC70, 0x68, 0x68, 0x2D0, 0xE0, 0x28, 0x30;
	byte	gamePaused:   0x1C7DC70, 0x68, 0x68, 0x278;
	byte 	numRockets: 0x1C7DC70, 0x68, 0x68, 0x2B0, 0x0, 0x5d8;
}
...
init{
	...
	else if (modules.First().ModuleMemorySize == 31178752)
		version = "1.1.61-steam";
	else
